...
#SBATCH --output=logs/gridlog_bnbnu_only_prod.%j.%A_%a.%N.log
#SBATCH --mem-per-cpu=8000
#SBATCH --cpus-per-task=1
#SBATCH --time=4-00:00:00
#SBATCH --partition=batch,preempt
#SBATCH --error=logs/griderr_bnbnu_only_prod.%j.%A_%a.%N.err
#SBATCH --array=0-9
...
singularity exec --nv --bind /cluster:/cluster,/cvmfs:/cvmfs $container bash -c "cd ${WORKDIR} && source ${WORKDIR}/run_bnb_nu_only.sh"
